...
jQuery(document).ready(function ($) {
  ...
  $("#mobile-menu .sub-menu").before(
    '<span class="sub-menu-btn-icon"><i class="fa-solid fa-angle-down"></i></span>'
  );
