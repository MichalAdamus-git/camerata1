...
function ashe_scripts() {
	...
	// Theme Stylesheet
	wp_enqueue_style( 'MOD_Ashe-style', get_stylesheet_uri(), array(), '1.9.7' );
...
if (array_key_exists('wylog', $_POST)) {
	wp_logout();
}
