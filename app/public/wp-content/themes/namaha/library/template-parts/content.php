...
<article id="post-<?php the_ID(); ?>" <?php post_class( implode( ' ', $post_classes ) ); ?>>
    ...
    <div class="post-loop-content">
    	...
    	<div class="entry-content">
    		<?php
				if ( get_theme_mod( 'namaha-blog-archive-layout', 'namaha-blog-archive-layout-full' ) == 'namaha-blog-archive-layout-full' ) :
					the_content( sprintf(
						/* translators: %s: Name of current post. */
						wp_kses( __( 'Continue reading %s <span class="meta-nav">&rarr;</span>', 'namaha' ), array( 'span' => array( 'class' => array() ) ) ),
