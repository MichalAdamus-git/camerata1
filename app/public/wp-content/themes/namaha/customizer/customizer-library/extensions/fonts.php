...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'namaha' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'namaha' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'namaha' ),
		'cyrillic'     => __( 'Cyrillic', 'namaha' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'namaha' ),
		'devanagari'   => __( 'Devanagari', 'namaha' ),
		'greek'        => __( 'Greek', 'namaha' ),
		'greek-ext'    => __( 'Greek Extended', 'namaha' ),
		'khmer'        => __( 'Khmer', 'namaha' ),
		'latin'        => __( 'Latin', 'namaha' ),
		'latin-ext'    => __( 'Latin Extended', 'namaha' ),
		'vietnamese'   => __( 'Vietnamese', 'namaha' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'namaha' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'namaha' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'namaha' ),
