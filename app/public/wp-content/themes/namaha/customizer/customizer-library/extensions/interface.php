		...
		foreach ( $options as $option ) {
			...
			if ( isset( $option['type'] ) ) {
				...
				switch ( $option['type'] ) {
					...
					case 'dropdown-product-categories':
								
						$wp_customize->add_control(
							new Customizer_Library_Dropdown_Product_Categories(
								$wp_customize,
								$option['id'], array(
									'label'             => $option['label'],
									'section'           => $option['section'],
					...
					case 'dropdown-primary-menu-top-level-items':
						
						$wp_customize->add_control(
							new Customizer_Library_Dropdown_Primary_Menu_Top_Level_Items(
								$wp_customize,
								$option['id'], array(
									'label'            => $option['label'],
									'section'          => $option['section'],
					...
					case 'dropdown-web-safe-fonts':
						
						$wp_customize->add_control(
							new Customizer_Library_Dropdown_Web_Safe_Fonts(
								$wp_customize,
								$option['id'], array(
									'label'            => $option['label'],
									'section'          => $option['section'],
